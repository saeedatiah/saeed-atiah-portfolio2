...
const Home = () => {
  return (
    <div class="w-screen h-screen" style={{backgroundImage:'url(./bg_home.jpg)'}}>
      ...
      <Navbar/>
      <div class="grid grid-cols-2 grid-rows-2 justify-stretch  pt-14 ">
      <div class="bg-orange-400 m-12 rounded-sm shadow-md">
aa
      </div>
      <div class="bg-amber-400 grid grid-rows-2 m-12 rounded-sm shadow-md">
      ...
      <div class="col-span-2 bg-slate-300 overflow-auto m-12 rounded-sm shadow-md">
      <p class="break-all ">
